/* File: triangles.c */
/* Find maximum and minimum area of random triangles */
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
#include <math.h>
...
{ int i, j, k, n = 10;
  ...
  if ((points = malloc(n * sizeof(struct point))) == NULL) { /* Allocate memory to store n points */
  ...
  max_tr = min_tr = tr; /* Initialize max and min triangles with first triangle */
